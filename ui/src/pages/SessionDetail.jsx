    ...
    <>
      ...
      <div className="card">
        <div className="card-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <span>{replay ? "🎬 Session Replay" : "Redirection Timeline"}</span>
          {replay?.summary?.autoGenerated > 0 && (
            <button
            ...
            >
              {showAutoGenerated ? "Hide" : "Show"} {replay.summary.autoGenerated} auto-generated
            </button>
          )}
        </div>
        {replay?.turns?.length > 0 ? (
          <div style={{ padding: "12px 0", maxHeight: 600, overflowY: "auto" }}>
            {replay.turns
              .filter((turn) => showAutoGenerated || !turn.autoGenerated)
              .map((turn) => (
              <div
                key={turn.turnIndex}
                style={{
                  ...
                  opacity: turn.autoGenerated ? 0.45 : 1,
                }}
              >
                ...
                <span style={{ fontSize: 16, minWidth: 24 }}>
                  {turn.autoGenerated ? "🤖" : (turn.speaker === "user" ? "👤" : "🤖")}
                </span>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 13, color: turn.autoGenerated ? "#6e7681" : "#e6edf3", marginBottom: turn.tags?.length ? 6 : 0, wordBreak: "break-word" }}>
                    {turn.messagePreview}
                  </div>
                  {turn.tags?.length > 0 && (
